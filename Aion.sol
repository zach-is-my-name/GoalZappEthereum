...
contract Aion {
    ...
    */
    function executeCall(uint256 blocknumber, address from, address to, uint256 value, uint256 gaslimit, uint256 gasprice,
        ...
        require(address(instance).execfunct(address(this), gasprice*gaslimit+fee, 2100, hex"00"));
        bool TxStatus = address(instance).execfunct(to, value, gasleft().sub(50000), data);
